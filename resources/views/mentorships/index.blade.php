                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pl-3 ">
                                                <li style="padding-bottom: 3px"><a href="#" class="View" data-id="{{ $d->id }}" style="text-decoration: none; color:#4e4c4c"><i class="fa fa-eye"></i> View</a></li>
                                                <li style="padding-bottom: 3px"><a href="#" class="edit" data-id="{{ $d->id }}" style="text-decoration: none; color:#4e4c4c"><i class="fa fa-edit"></i> Edit</a></li>
                                                <li style="padding-bottom: 3px"><a href="#" class="delete" data-id="{{ $d->id }}" style="text-decoration: none; color:#4e4c4c">
