...
@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['mentorships.update', $data->id]]) !!}
    @csrf
    @method('patch')
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12 form-group">
                        ...
                        {!! Form::number('duration', $data->duration , ['class' => 'form-control', 'placeholder' => '']) !!}
                        <p class="help-block"></p>
                        @error('duration')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12 form-group">
                        ...
                        {!! Form::date('start_date', $data->start_date, ['class' => 'form-control', 'placeholder' => '']) !!}
                        <p class="help-block"></p>
                        @error('start_date')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12 form-group">
                        ...
                        {!! Form::date('end_date', $data->end_date, ['class' => 'form-control', 'placeholder' => '']) !!}
                        <p class="help-block"></p>
                        @error('end_date')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12 form-group">
                        ...
                        {!! Form::number('total_assignment_expected', $data->total_assignment_expected, ['class' => 'form-control', 'placeholder' => '']) !!}
                        <p class="help-block"></p>
