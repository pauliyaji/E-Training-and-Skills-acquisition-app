            ...
            <div class="container-fluid">
                <div class="m-2">
                    <h4 class="m-1 pt-1 font-weight-bold text-primary">{{ $data->name }}'s Profile
                        <a href="{{ route('mentors.index') }}" class="float-right btn btn-success btn-sm mb-2">View All</a>
                    </h4>
                </div>
            </div>
            <!-- /.container-fluid -->
                ...
                <div class="col-md-4" style="margin-right: 20px; margin-top: 5px; margin-left: 15px;">
                    ...
                    <div style="display: flex; padding:5px;">
                        <div class="col-md-10 col-xs-12 m-0 p-0">
                            <br/>
                                <p style="font-size: 14px; font-weight: bold;">Organisation: <span style="font-weight: normal">{{ $menprofile->company }}</span></p>
                                <p style="font-size: 14px; font-weight: bold;">Area of Specialization: <span style="font-weight: normal">{{ $menprofile->area }}</span></p>
                                <p style="font-size: 14px; font-weight: bold;">Vocational Skills: <span style="font-weight: normal">{{ $menprofile->categories->category }}</span></p>
