    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">All My Feedback
                    <a href="javascript:void(0)">
                        <a href="{{ route('feedbacks.index') }}"><button type="button"class="btn btn-success btn-flat add_new_feedbacks m-1 float-right" data-name="">
                            View All Feedback</button></a>
